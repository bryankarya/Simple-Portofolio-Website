$(document).ready(function () {
    ...
    $(document).on("click", "#submit", function (e) {
        e.preventDefault();
        $("#create-experience-form").submit(); // Trigger the form submission
    });

    // Handle form submission using AJAX
    $("#create-experience-form").on("submit", function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: base_url + "/admin/experience/store", // Endpoint to submit data to
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
